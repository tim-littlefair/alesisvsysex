...
Currently, this software is only known to work on Linux, and supports the Alesis V25, V49, and V61 controllers. It includes a model for the parts of the SysEx protocol I was able to reverse (i.e., most of it), the ability to fetch and update the device config, and the ability to store and load configurations as files.
...
## Acknowledgements and forks for additional device support

V49, V61, and program change support were contributed by [@tim-littlefair](https://github.com/tim-littlefair).

Forks were created by [@Baggypants for VMini](https://github.com/Baggypants/alesisvsysex) and by  [@abridgewater for VI49](https://github.com/abridgewater/alesisvsysex).
